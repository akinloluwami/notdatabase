                ...
                <CardContent className="space-y-4">
                  {!hasPassword && (
                    <div className="p-4 bg-blue-900/20 border border-blue-700/30 rounded-md">
                      <p className="text-sm text-blue-300">
                        You don't have a password set. You can only sign in with
                        your email provider.
                      </p>
                    </div>
                  )}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      disabled={!hasPassword}
                      placeholder={
                        hasPassword ? "Confirm new password" : "No password set"
                      }
                    />
                  </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-center py-8 text-gray-400">
                    ...
                    <p className="text-sm">
                      Your invoices will appear here once you upgrade to a paid
                      plan
                    </p>
                  </div>
                </CardContent>
